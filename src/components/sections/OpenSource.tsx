        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {repos.map((repo) => (
            <Link 
              ...
              href={repo.html_url} 
              target="_blank"
              className="group block p-6 bg-zinc-50 dark:bg-zinc-900/50 rounded-lg border border-border hover:border-blue-500/50 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transition-all"
            >
